...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_instList = 15,                  /* instList  */
  YYSYMBOL_inst = 16,                      /* inst  */
  YYSYMBOL_E = 17,                         /* E  */
  YYSYMBOL_T = 18,                         /* T  */
  YYSYMBOL_F = 19                          /* F  */
};
...
static const char *const yytname[] =
{
  ...
  "IDENT", "START", "END", "ASSIGN", "SEMICOLON", "PRINT", "PLUS", "MULT",
  "$accept", "program", "instList", "inst", "E", "T", "F", YY_NULLPTR
};
...
{
       0,     0,     0,     0,     2,     4,     0,    11,    12,     0,
       1,     3,     0,     8,    10,     6,     5,     0,     0,     7,
       9
};
...
{
       9,     1,     7,    16,     8,    17,     2,    10,     6,    18,
      15,     0,    11,     0,     0,     0,    20,     0,     0,    19
};

static const yytype_int8 yycheck[] =
{
       2,     5,     3,     9,     5,    11,    10,     0,     8,    12,
       9,    -1,     4,    -1,    -1,    -1,    18,    -1,    -1,    17
};
...
{
       0,     5,    10,    14,    15,    16,     8,     3,     5,    19,
       0,    16,    17,    18,    19,     9,     9,    11,    12,    18,
      19
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* program: instList  */
#line 31 "exo17.y"
                   { printf("program\n"); }
#line 1088 "exo17.c"
    break;

  case 5: /* inst: IDENT ASSIGN E SEMICOLON  */
#line 38 "exo17.y"
                                { printf("assign %s with %d \n",(yyvsp[-3].sval),(yyvsp[-1].ival)); }
#line 1094 "exo17.c"
    break;

  case 6: /* inst: PRINT F SEMICOLON  */
#line 39 "exo17.y"
                         {printf("print \n");}
#line 1100 "exo17.c"
    break;
...
#line 1124 "exo17.c"
  ...
  case 11: /* F: INTEGER  */
#line 53 "exo17.y"
           {(yyval.ival)=(yyvsp[0].ival); printf("integer expr $$ i:%d \n", (yyvsp[0].ival)); }
#line 1130 "exo17.c"
    break;
